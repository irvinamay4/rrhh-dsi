...
public class HorasNocturnas {
    ...
    public HorasNocturnas(Long id, double enero, double febrero, double marzo, double abril, double mayo, double junio, double julio, double agosto, double septiembre, double octubre, double noviembre, double diciembre) {
        this.id = id;
        this.enero = enero;
